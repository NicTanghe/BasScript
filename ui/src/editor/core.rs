...
use basscript_core::{
    Cursor, Document, DocumentFormat, DocumentPath, EntityDocument, LineKind, ParsedLine,
    Position, is_valid_target_key, parse_document_with_format, scaffold_entity,
    script_link_contains_visible_column,
};
use bevy::{
    input::{
