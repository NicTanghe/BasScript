...
impl WinitWindows {
    ...
    pub fn create_window(
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            // Transparent DX12 composition requires the window to opt out of the
            // default redirection surface so the swapchain can supply the content.
            winit_window_attributes =
                winit_window_attributes.with_no_redirection_bitmap(window.transparent);
        }
